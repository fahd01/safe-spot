 ...
 */
class getVichUploader_Listener_Clean_UserAvatarService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.user_avatar'])) {
            return $container->privates['vich_uploader.listener.clean.user_avatar'];
        }

        return $container->privates['vich_uploader.listener.clean.user_avatar'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('user_avatar', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
