...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\ActualiteType' => ['privates', 'App\\Form\\ActualiteType', 'getActualiteTypeService', true],
            'App\\Form\\AdminBidType' => ['privates', 'App\\Form\\AdminBidType', 'getAdminBidTypeService', true],
            'App\\Form\\AdminLoanType' => ['privates', 'App\\Form\\AdminLoanType', 'getAdminLoanTypeService', true],
            'App\\Form\\AutomationRuleType' => ['privates', 'App\\Form\\AutomationRuleType', 'getAutomationRuleTypeService', true],
            'App\\Form\\AutomationType' => ['privates', 'App\\Form\\AutomationType', 'getAutomationTypeService', true],
            'App\\Form\\BidType' => ['privates', 'App\\Form\\BidType', 'getBidTypeService', true],
            ...
            'App\\Form\\CommentaireType' => ['privates', 'App\\Form\\CommentaireType', 'getCommentaireTypeService', true],
            'App\\Form\\DonsType' => ['privates', 'App\\Form\\DonsType', 'getDonsTypeService', true],
            'App\\Form\\InvestissementType' => ['privates', 'App\\Form\\InvestissementType', 'getInvestissementTypeService', true],
            'App\\Form\\LikenewsType' => ['privates', 'App\\Form\\LikenewsType', 'getLikenewsTypeService', true],
            'App\\Form\\LoanType' => ['privates', 'App\\Form\\LoanType', 'getLoanTypeService', true],
            'App\\Form\\ModificationFormType' => ['privates', 'App\\Form\\ModificationFormType', 'getModificationFormTypeService', true],
            'App\\Form\\RecResponseType' => ['privates', 'App\\Form\\RecResponseType', 'getRecResponseTypeService', true],
            ...
            'App\\Form\\SendMailType' => ['privates', 'App\\Form\\SendMailType', 'getSendMailTypeService', true],
            'App\\Form\\StarRepType' => ['privates', 'App\\Form\\StarRepType', 'getStarRepTypeService', true],
            ...
            'App\\Form\\ActualiteType' => '?',
            'App\\Form\\AdminBidType' => '?',
            'App\\Form\\AdminLoanType' => '?',
            'App\\Form\\AutomationRuleType' => '?',
            'App\\Form\\AutomationType' => '?',
            'App\\Form\\BidType' => '?',
            'App\\Form\\ChangePasswordFormType' => '?',
            'App\\Form\\ChangePasswordType' => '?',
            'App\\Form\\CommentaireType' => '?',
            'App\\Form\\DonsType' => '?',
            'App\\Form\\InvestissementType' => '?',
            'App\\Form\\LikenewsType' => '?',
            'App\\Form\\LoanType' => '?',
            'App\\Form\\ModificationFormType' => '?',
            'App\\Form\\RecResponseType' => '?',
            'App\\Form\\ReclamationType' => '?',
            'App\\Form\\RegistrationFormType' => '?',
            'App\\Form\\ResetPasswordRequestFormType' => '?',
            'App\\Form\\SendMailType' => '?',
            'App\\Form\\StarRepType' => '?',
