...
class __TwigTemplate_3d1760f9966d93cf13f514d7c014f25c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"center\">
        ...
        echo "
            <div class=\"txt_field\">
                ";
        // line 131
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 131, $this->source); })()), "plainPassword", [], "any", false, false, false, 131), 'widget');
        echo "
                ";
        // line 132
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 132, $this->source); })()), "plainPassword", [], "any", false, false, false, 132), 'errors');
        echo "
            </div>
            <div class=\"button\">
            ...
            ";
        // line 138
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 138, $this->source); })()), 'form_end');
        echo "
...
";
    ...
    {
        return array (  228 => 145,  222 => 142,  215 => 138,  206 => 132,  202 => 131,  197 => 129,  80 => 15,  66 => 3,  47 => 2,  44 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"center\">
        ...
        <form method=\"post\">
            ...
            <div class=\"txt_field\">
                {{ form_widget(requestForm.plainPassword) }}
                {{  form_errors(requestForm.plainPassword)}}
            </div>
            <div class=\"button\">
                <input type=\"submit\" value=\"Reset\">
            </div>
...
{% endblock %}", "reset_password/reset.html.twig", "C:\\Users\\user\\Desktop\\safe-spot-main\\templates\\reset_password\\reset.html.twig");
    }
}
