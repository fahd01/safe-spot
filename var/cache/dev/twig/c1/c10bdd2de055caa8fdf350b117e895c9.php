...
class __TwigTemplate_9e1acaa9d0a6f059ce49d7c3afdfac10 extends Template
{
    private $source;
    private $macros = [];
          ...
          <div class=\"col-lg-7 mx-auto text-white\">
            <div class=\"row align-items-center d-flex flex-row\">
              ...
              <div class=\"col-lg-6 error-page-divider text-lg-left pl-lg-4\">
                <h2>SORRY!</h2>
                <h3 class=\"font-weight-light\">Access denied! You are not allowed to access this page.</h3>
              </div>
            </div>
            <div class=\"row mt-5\">
...
", "@Twig/Exception/error403.html.twig", "/var/safe-spot/safe-spot/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
