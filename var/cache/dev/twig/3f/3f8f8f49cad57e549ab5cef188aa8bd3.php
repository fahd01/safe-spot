...
class __TwigTemplate_b4cae38355e2630681737662142359c5 extends Template
{
    private $source;
    private $macros = [];
...
<a href=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 13, $this->source); })()), "token", [], "any", false, false, false, 13)]), "html", null, true);
        echo "\"> ";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 13, $this->source); })()), "token", [], "any", false, false, false, 13)]), "html", null, true);
        echo "</a>
...
", "reset_password/email.html.twig", "C:\\Users\\user\\Desktop\\safe-spot-main\\templates\\reset_password\\email.html.twig");
    }
}
