...
class __TwigTemplate_f61a2074625f06cd058915205a499e12 extends Template
{
    private $source;
    private $macros = [];
                ...
                <div class=\"col-xl-9\">
                    ...
                    <div class=\"card\" style=\"border-radius: 15px;\">
                        <div class=\"card-body\">
                            ...
                            <div class=\"px-5 py-4\">
                                <button type=\"submit\" class=\"btn btn-primary btn-lg\">Send mail</button>
                                <button  class=\"btn btn-warning btn-lg\"><a href=\"{{ path('afficheall') }}\">return</a></button>
                            </div>
                            {{ form_end(form) }}
                            <button id=\"start\" class=\"btn btn-primary btn-block\">
                                Start Recording
...
{% endblock %}", "admin/sendMail.html.twig", "/var/safe-spot/templates/admin/sendMail.html.twig");
    }
}
