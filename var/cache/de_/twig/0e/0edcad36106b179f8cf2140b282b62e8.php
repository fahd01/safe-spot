...
class __TwigTemplate_58c9839b6defcb1a6b5e571d2cd15303 extends Template
{
    private $source;
    private $macros = [];
...
<!--                                        <td> ";
                ...
                echo "\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["bid"], "bidder", [], "any", false, false, false, 103), "prenom", [], "any", false, false, false, 103), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["bid"], "bidder", [], "any", false, false, false, 103), "nom", [], "any", false, false, false, 103), "html", null, true);
                echo " </a>
                                        </td>
                                        <td>
...
<!--                                        <td> {{ bid.id }} </td>-->
                                        ...
                                        <td class=\"py-1\">
                                            ...
                                            <a href=\"/users/{{bid.bidder.id}}\">{{ bid.bidder.prenom }} {{ bid.bidder.nom }} </a>
                                        </td>
                                        <td>
...
{% endblock %}
", "loans/myLoans.html.twig", "/var/safe-spot/templates/loans/myLoans.html.twig");
    }
}
