        ...
        if (tuner_el.length && style_el.length) {
          el.ColorPicker({
            ...
            onChange: function (hsb, hex, rgb) {
              el.css("Backendground-color", "#" + hex);
              tuner_el.find("span").text(hex);
              tuner_el
                .find("span.darknest")
                .text(cws_Hex2RGBwithdark(hex, 1.14));
