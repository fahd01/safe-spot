...
!(function (t, e) {
  ...
  (i.prototype.axisX = function (t, e, i) {
    ...
    (i.prototype.splitTickText = function (t, e) {
      ...
      if ("[object Array]" === Object.prototype.toString.call(i)) return i;
      return (
        (!c || c <= 0) &&
          (c = s.isVertical()
            ? 95
  ...
  (f.prototype.init = function () {
    ...
    (f.prototype.getXAxis = function (t, e, i, n, r, a, o) {
      var s = this.owner,
        c = s.config,
        d = {
    ...
    (f.prototype.updateXAxisTickValues = function (t, e) {
      var i,
        n = this.owner,
        r = n.config;
      return (
    ...
    (f.prototype.getYAxis = function (t, e, i, n, r, a, o) {
      var s = this.owner,
        c = s.config,
        d = c["axis_".concat(t, "_tick_format")];
      !d &&
        s.isAxisNormalized(t) &&
        (d = function (t) {
          return "".concat(t, "%");
        });
    ...
    (f.prototype.getTickValues = function (t, e) {
    ...
    (f.prototype.getLabelOptionByAxisId = function (t) {
      var e,
        i = this.owner.config;
      return (
        "y" === t
    ...
    (f.prototype.getLabelText = function (t) {
      var e = this.getLabelOptionByAxisId(t);
      return p(e) ? e : e ? e.text : null;
    }),
    (f.prototype.setLabelText = function (t, e) {
    ...
    (f.prototype.getLabelPosition = function (t, e) {
    ...
    (f.prototype.getLabelPositionById = function (t) {
      return "y2" === t
    ...
    (f.prototype.xForAxisLabel = function (t, e) {
      var i = this.owner;
      return t
        ? e.isLeft
          ? 0
    ...
    (f.prototype.dxForAxisLabel = function (t, e) {
      return t
        ? e.isLeft
          ? "0.5em"
          : e.isRight
    ...
    (f.prototype.textAnchorForAxisLabel = function (t, e) {
      return t
        ? e.isLeft
          ? "start"
          : e.isCenter
    ...
    (f.prototype.dyForXAxisLabel = function () {
      ...
      return e.axis_rotated
        ...
        : i.isInner
        ? "-0.5em"
        : t.getHorizontalAxisHeight("x") - 10;
    }),
    ...
    (f.prototype.getMaxTickWidth = function (t, e) {
      var i,
        n,
        r,
        a,
    ...
    (f.prototype.updateLabels = function (t) {
      var e = this.owner,
    ...
    (f.prototype.getPadding = function (t, e, i, n) {
    ...
    (f.prototype.convertPixelsToAxisPadding = function (t, e) {
      var i = this.owner;
      return e * (t / (i.config.axis_rotated ? i.width : i.height));
    }),
    (f.prototype.generateTickValues = function (t, e, i) {
      var n,
        r,
        a,
        o,
    ...
    (f.prototype.generateTransitions = function (t) {
    ...
    (f.prototype.redraw = function (t, e) {
      var i = this.owner,
  ...
  var t = {
    ...
    chart: {
      ...
      internal: {
        fn: l.prototype,
        axis: { fn: f.prototype, internal: { fn: i.prototype } },
      },
    },
    generate: function (t) {
      return new n(t);
  ...
  function x(t, e, i) {
    ...
    return (
      e || (e = t.scaleLinear()).range(n),
      i || ((i = t.scaleLog()).domain(n), i.nice()),
      (r.domain = function (t) {
        return arguments.length ? (e.domain(t), r) : e.domain();
      }),
      (r.range = function (t) {
        return arguments.length ? (i.range(t), r) : i.range();
      }),
      (r.ticks = function (t) {
        return (function (t, e, i) {
          var n, r, a, o;
          if (arguments.length < 3) i = 10;
          else if (0 === i) return [];
          (o = (e - t) / (r = i - 1)),
            (a = t),
            ((n = new Array(i))[0] = Math.pow(10, a));
          for (var s = 1; s < r; s++) (a += o), (n[s] = Math.pow(10, a));
          return (n[r] = Math.pow(10, e)), n;
        })(-2, 1, t || 10).map(function (t) {
          return e.invert(t);
        });
      }),
      (r.copy = function () {
        return x(t, e.copy(), i.copy());
      }),
      r
    );
  }
  ...
  (l.prototype.beforeInit = function () {}),
    ...
    (l.prototype.redraw = function (t, e) {
      var i,
        ...
        k = I.d3,
        F = I.config,
        D = I.getShapeIndices(I.isAreaType),
        X = I.getShapeIndices(I.isBarType),
        z = I.getShapeIndices(I.isLineType),
        M = I.hasArcType(),
        H = I.filterTargetsToShow(I.data.targets),
        N = I.xv.bind(I);
      if (
        ((i = B((t = t || {}), "withY", !0)),
        (n = B(t, "withSubchart", !0)),
        (r = B(t, "withTransition", !0)),
        (s = B(t, "withTransform", !1)),
        (c = B(t, "withUpdateXDomain", !1)),
        (d = B(t, "withUpdateOrgXDomain", !1)),
        (l = B(t, "withTrimXDomain", !0)),
        (p = B(t, "withUpdateXAxis", c)),
        (u = B(t, "withLegend", !1)),
        (h = B(t, "withEventRect", !0)),
        (g = B(t, "withDimension", !0)),
        (a = B(t, "withTransitionForExit", r)),
        (o = B(t, "withTransitionForAxis", r)),
        (S = r ? F.transition_duration : 0),
        (w = a ? S : 0),
        (v = o ? S : 0),
        (e = e || I.axis.generateTransitions(v)),
        u && F.legend_show
          ? I.updateLegend(I.mapToIds(I.data.targets), t, e)
          : g && I.updateDimension(!0),
        I.isCategorized() &&
          0 === H.length &&
          I.x.domain([0, I.axes.x.selectAll(".tick").size()]),
        H.length
          ? (I.updateXDomain(H, c, d, l),
            F.axis_x_tick_values || (C = I.axis.updateXAxisTickValues(H)))
          : (I.xAxis.tickValues([]), I.subXAxis.tickValues([])),
        F.zoom_rescale && !t.flow && (G = I.x.orgDomain()),
        I.y.domain(I.getYDomain(H, "y", G)),
        I.y2.domain(I.getYDomain(H, "y2", G)),
        !F.axis_y_tick_values &&
          F.axis_y_tick_count &&
          I.yAxis.tickValues(
            I.axis.generateTickValues(I.y.domain(), F.axis_y_tick_count)
          ),
        !F.axis_y2_tick_values &&
          F.axis_y2_tick_count &&
          I.y2Axis.tickValues(
            I.axis.generateTickValues(I.y2.domain(), F.axis_y2_tick_count)
          ),
        I.axis.redraw(v, M),
        I.axis.updateLabels(r),
        (c || p) && H.length)
      )
        if (F.axis_x_tick_culling && C) {
          for (L = 1; L < C.length; L++)
            if (C.length / L < F.axis_x_tick_culling_max) {
              V = L;
              break;
            }
          I.svg.selectAll("." + Y.axisX + " .tick text").each(function (t) {
            var e = C.indexOf(t);
          ...
          I.svg
            ...
            .style("display", "block");
      (f = I.generateDrawArea ? I.generateDrawArea(D, !1) : void 0),
        (_ = I.generateDrawBar ? I.generateDrawBar(X) : void 0),
        (x = I.generateDrawLine ? I.generateDrawLine(z, !1) : void 0),
        (y = I.generateXYForText(D, X, z, !0)),
        (m = I.generateXYForText(D, X, z, !1)),
        I.updateCircleY(),
        ...
        R.select("text." + Y.text + "." + Y.empty)
          .attr("x", I.width / 2)
          .attr("y", I.height / 2)
          .text(F.data_empty_label_text)
          .transition()
          .style("opacity", H.length ? 0 : 1),
        h && I.redrawEventRect(),
        I.updateGrid(S),
        I.updateStanfordElements(S),
        I.updateRegion(S),
        I.updateBar(w),
        I.updateLine(w),
        I.updateArea(w),
        I.updateCircle(E, O),
        I.hasDataLabel() && I.updateText(y, m, w),
        I.redrawTitle && I.redrawTitle(),
        I.redrawArc && I.redrawArc(S, w, s),
        I.redrawSubchart && I.redrawSubchart(n, e, S, w, D, X, z),
        I.isStanfordGraphType() && I.drawColorScale(),
        ...
        S && I.isTabVisible()
          ? ((P = k.transition().duration(S)),
            ...
            [
              ...
              I.redrawLine(x, !0, P),
              I.redrawArea(f, !0, P),
              I.redrawCircle(E, O, !0, P),
              I.redrawText(y, m, t.flow, !0, P),
              I.redrawRegion(!0, P),
              I.redrawGrid(!0, P),
            ].forEach(function (t) {
            ...
            T(function () {
              A && A(), F.onrendered && F.onrendered.call(I);
            }))
          : (I.redrawBar(_),
            I.redrawLine(x),
            I.redrawArea(f),
            I.redrawCircle(E, O),
            I.redrawText(y, m, t.flow),
            I.redrawRegion(),
            I.redrawGrid(),
            A && A(),
            F.onrendered && F.onrendered.call(I)),
    ...
    (l.prototype.updateAndRedraw = function (t) {
      ...
      ((t = t || {}).withTransition = B(t, "withTransition", !0)),
        ...
        (t.withTransitionForTransform = B(
          t,
    ...
    (l.prototype.getTranslate = function (t) {
      ...
      return (
        "main" === t
          ? ((e = o(n.margin.left)), (i = o(n.margin.top)))
          : "context" === t
          ? ((e = o(n.margin2.left)), (i = o(n.margin2.top)))
          : "legend" === t
    ...
    (l.prototype.opacityForCircle = function (t) {
      var e =
        (g(this.config.point_show)
          ? this.config.point_show(t)
          : this.config.point_show) || this.isStanfordType(t)
          ? 1
          : 0;
      return C(t.value) ? (this.isScatterType(t) ? 0.5 : e) : 0;
    }),
    ...
    (l.prototype.xvCustom = function (t, e) {
      ...
      return (
        i.isTimeSeries()
          ? (n = i.parseDate(t.value))
          : i.isCategorized() &&
            "string" == typeof t.value &&
            (n = i.config.axis_x_categories.indexOf(t.value)),
        Math.ceil(i.x(n))
      );
    }),
    ...
    (n.prototype.axis.max = function (t) {
      ...
      "object" === s(t)
        ? (C(t.x) && (i.axis_x_max = t.x),
          C(t.y) && (i.axis_y_max = t.y),
          C(t.y2) && (i.axis_y2_max = t.y2))
    ...
    (n.prototype.axis.min = function (t) {
      ...
      "object" === s(t)
        ? (C(t.x) && (i.axis_x_min = t.x),
          C(t.y) && (i.axis_y_min = t.y),
          C(t.y2) && (i.axis_y2_min = t.y2))
    ...
    (n.prototype.axis.types = function (t) {
      var e = this.internal;
      if (void 0 === t)
        return { y: e.config.axis_y_type, y2: e.config.axis_y2_type };
      ...
      if (t) {
        ...
        i &&
          ...
          (e = i.reduce(function (t, e) {
            ...
            return n ? (t = t.concat(i)) : t.push(i), t;
          }, []));
      }
      return e;
    }),
    ...
    ((n.prototype.donut = function () {}).padAngle = function (t) {
        ...
        L.add(E.xAxis(E.axes.x, V)),
          ...
          L(function () {
            ...
            n
              ...
              r
                .select("line")
                .attr("x1", O.axis_rotated ? 0 : x)
                .attr("x2", O.axis_rotated ? E.width : x),
              r
                .select("text")
                .attr("x", O.axis_rotated ? E.width : 0)
                .attr("y", x),
    ...
    (n.prototype.load = function (e) {
      ...
      e.xs && t.addXs(e.xs),
        ...
        "cacheIds" in e && t.hasCaches(e.cacheIds)
          ...
          : e.unload
          ? t.unload(
              t.mapToTargetIds(!0 === e.unload ? null : e.unload),
              function () {
                t.loadFromArgs(e);
              }
            )
    ...
    ((n.prototype.pie = function () {}).padAngle = function (t) {
    ...
    (n.prototype.regions.remove = function (t) {
      var e,
        ...
        a = r.config;
      return (
        (e = B((t = t || {}), "duration", a.transition_duration)),
        (i = B(t, "classes", [Y.region])),
    ...
    (l.prototype.getPadAngle = function () {
      return this.hasType("pie")
        ? this.config.pie_padAngle || 0
        : (this.hasType("donut") && this.config.donut_padAngle) || 0;
    }),
    ...
    (l.prototype.convertDataToTargets = function (t, n) {
      var e,
        ...
        u = l.config;
      if (
        (h(t) ? (a = Object.keys(t[0])) : ((a = t.keys), (t = t.rows)),
        (r = a.filter(l.isX, l)),
        l.isStanfordGraphType())
      ) {
        if (
          ((d = a.filter(l.isEpochs, l)),
      ...
      } else i = a.filter(l.isNotX, l);
      return (
        i.forEach(function (i) {
          var e = l.getXKey(i);
          l.isCustomX() || l.isTimeSeries()
            ? 0 <= r.indexOf(e)
              ? (l.data.xs[i] = (n && l.data.xs[i] ? l.data.xs[i] : []).concat(
                  t
                    .map(function (t) {
                      return t[e];
                    })
              ...
              : u.data_x
              ? (l.data.xs[i] = l.getOtherTargetXs())
              : L(u.data_xs) &&
                (l.data.xs[i] = l.getXValuesOfXKey(e, l.data.targets))
            : (l.data.xs[i] = t.map(function (t, e) {
                return e;
              }));
        }),
        i.forEach(function (t) {
            ...
            values: t
              .map(function (t, e) {
                var i,
                  n,
                  r = t[l.getXKey(o)],
                  a = null === t[o] || isNaN(t[o]) ? null : +t[o];
                return (
                  l.isCustomX() && l.isCategorized() && !v(r)
                    ? (0 === s && 0 === e && (u.axis_x_categories = []),
                      -1 === (i = u.axis_x_categories.indexOf(r)) &&
                        ((i = u.axis_x_categories.length),
                        u.axis_x_categories.push(r)))
                    : (i = l.generateTargetX(r, o, e)),
                  (v(t[o]) || l.data.xs[o].length <= e) && (i = void 0),
                  (n = { x: i, value: a, id: c }),
        ...
        u.data_type &&
          l.setTargetType(
            l.mapToIds(e).filter(function (t) {
    ...
    (l.prototype.isStackNormalized = function () {
      return (
        this.config.data_stack_normalize && 0 < this.config.data_groups.length
      );
    }),
    ...
    (l.prototype.isTargetNormalized = function (e) {
      return (
        ...
        this.config.data_groups.some(function (t) {
          return t.includes(e);
        })
      );
    }),
        ...
        e.data.targets
          ...
          .forEach(function (t) {
            ...
            t.values.forEach(function (t, e) {
              i[e] || (i[e] = 0), (i[e] += d(t.value) ? t.value : 0);
            });
          }),
    ...
    (l.prototype.getTotalDataSum = function () {
      ...
      var i,
        ...
        Array.isArray(i) ? (n = []).concat.apply(n, a(i)) : [])
          .map(function (t) {
            return t.value;
          })
          .reduce(function (t, e) {
      ...
      return e.addToCache("getTotalDataSum", r), r;
    }),
    (l.prototype.getXValuesOfXKey = function (e, t) {
      var i,
        n = this;
      return (
        (t && L(t) ? n.mapToIds(t) : []).forEach(function (t) {
    ...
    (l.prototype.getXValue = function (t, e) {
      return t in this.data.xs && this.data.xs[t] && C(this.data.xs[t][e])
        ? this.data.xs[t][e]
        : e;
    }),
    ...
    (l.prototype.getOrderFunction = function () {
      ...
      if (g(t.data_order)) return t.data_order;
      if (h(t.data_order)) {
        var i = t.data_order;
        return function (t, e) {
    ...
    (l.prototype.hasDataLabel = function () {
      ...
      return (
        ...
        !("object" !== s(t.data_labels) || !L(t.data_labels))
      );
    }),
    ...
    (l.prototype.findClosestFromTargets = function (t, e) {
      var i = this,
        n = t
          .map(function (t) {
            return i.findClosest(
              t.values,
              e,
              i.config.tooltip_horizontal
                ? i.horizontalDistance.bind(i)
                : i.dist.bind(i),
              i.config.point_sensitivity
            );
          })
          .filter(function (t) {
            return t;
      ...
      return 0 === n.length
        ...
        : 1 === n.length
        ? n[0]
        : i.findClosest(n, e, i.dist.bind(i));
    }),
      ...
      return (
        t.forEach(function (t) {
          t.values.forEach(function (t) {
            ...
            (void 0 === r || e < r) && ((n = t), (r = e));
          });
        }),
        n
      );
    }),
    (l.prototype.findClosest = function (t, i, n) {
      var r,
        a =
            ...
            if (!r) {
              var e = o.main
                .select(
                  "." +
                    Y.bars +
                    o.getTargetSelectorSuffix(t.id) +
                    " ." +
                    Y.bar +
                    "-" +
                    t.index
    ...
    (l.prototype.getRatio = function (t, e) {
      var i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
        n = this,
        r = n.api,
        a = 0;
      if (e && r.data.shown.call(r).length)
        if (((a = e.ratio || e.value), "arc" === t))
          if (n.hasType("gauge"))
            a =
              (e.endAngle - e.startAngle) /
              (Math.PI * (n.config.gauge_fullCircle ? 2 : 1));
          else {
            var o = n.getTotalDataSum();
            a = e.value / o;
          }
        else if ("index" === t) {
          var s = n.getTotalPerIndex(n.axis.getId(e.id));
          (e.ratio =
            d(e.value) && s && 0 < s[e.index] ? e.value / s[e.index] : 0),
            (a = e.ratio);
        }
      return i && a ? 100 * a : a;
    }),
    ...
    (l.prototype.loadFromArgs = function (e) {
      ...
      i.resetCache(),
        e.data
          ...
          : e.json
          ? i.load(
              i.convertDataToTargets(i.convertJsonToData(e.json, e.keys)),
              e
            )
          : e.rows
    ...
    (l.prototype.getYDomain = function (t, e, i) {
      var n = this,
        r = n.config;
      if (n.isAxisNormalized(e)) return [0, 100];
      var a,
        o,
        s,
        c,
        ...
        _ = i ? n.filterByXDomain(f, i) : f,
        x = "y2" === e ? r.axis_y2_min : r.axis_y_min,
        y = "y2" === e ? r.axis_y2_max : r.axis_y_max,
        m = n.getYDomainMin(_),
        S = n.getYDomainMax(_),
        w = "y2" === e ? r.axis_y2_center : r.axis_y_center,
        v =
          (n.hasType("bar", _) && r.bar_zerobased) ||
          (n.hasType("area", _) && r.area_zerobased),
        b = "y2" === e ? r.axis_y2_inverted : r.axis_y_inverted,
        T = n.hasDataLabel() && r.axis_rotated,
        A = n.hasDataLabel() && !r.axis_rotated;
      if (
        ((m = C(x) ? x : C(y) ? (m < y ? m : y - 10) : m),
        (S = C(y) ? y : C(x) ? (x < S ? S : x + 10) : S),
        0 === _.length)
      )
        return "y2" === e ? n.y2.domain() : n.y.domain();
      if (
        (isNaN(m) && (m = 0),
        isNaN(S) && (S = m),
        m === S && (m < 0 ? (S = 0) : (m = 0)),
        ...
        ((C(x) && g) || (C(y) && p)) && (v = !1),
        v && (g && (m = 0), p && (S = 0)),
        (s = c = 0.1 * (o = Math.abs(S - m))),
        void 0 !== w &&
          ((S = w + (d = Math.max(Math.abs(m), Math.abs(S)))), (m = w - d)),
        T)
      )
        (l = n.getDataLabelLength(m, S, "width")),
          (u = R(n.y.range())),
          (s += o * ((h = [l[0] / u, l[1] / u])[1] / (1 - h[0] - h[1]))),
          (c += o * (h[0] / (1 - h[0] - h[1])));
      else if (A) {
        l = n.getDataLabelLength(m, S, "height");
        var P = n.getY(
          r["axis_".concat(e, "_type")],
          [0, r.axis_rotated ? n.width : n.height],
          [0, o]
        );
        (s += P(l[1])), (c += P(l[0]));
      }
      return (
        "y" === e &&
          L(r.axis_y_padding) &&
          ((s = n.axis.getPadding(r.axis_y_padding, "top", s, o)),
          (c = n.axis.getPadding(r.axis_y_padding, "bottom", c, o))),
        "y2" === e &&
          L(r.axis_y2_padding) &&
          ((s = n.axis.getPadding(r.axis_y2_padding, "top", s, o)),
      ...
      return (
        (i = this.isCategorized()
          ...
          ? 1 < (e = this.getMaxDataCount())
            ...
            : 0.5
          : 0.01 * o),
        "object" === s(a.axis_x_padding) && L(a.axis_x_padding)
          ? ((n = C(a.axis_x_padding.left) ? a.axis_x_padding.left : i),
            (r = C(a.axis_x_padding.right) ? a.axis_x_padding.right : i))
          : (n = r =
    ...
    (l.prototype.redrawEventRect = function () {
      ...
      s.main
        ...
        s.eventRect
            ...
            d.interaction_enabled
              ? function () {
                  d &&
                    (s.hasArcType() ||
                      (s.mouseover &&
                        (d.data_onmouseout.call(s.api, s.mouseover),
                        (s.mouseover = void 0)),
                      l()));
                }
              : null
              ...
              ? function () {
                  if (!s.dragging) {
                    ...
                    if (!s.hasArcType(t)) {
                      var e,
                        i = c.mouse(this),
                        n = h(s.findClosestFromTargets(t, i)),
                        r = u(i, n);
                      if (
                        (!s.mouseover ||
                          (n &&
                            n.id === s.mouseover.id &&
                            n.index === s.mouseover.index) ||
                          (d.data_onmouseout.call(s.api, s.mouseover),
                          (s.mouseover = void 0)),
                        n &&
                          !s.mouseover &&
                          (d.data_onmouseover.call(s.api, n),
                          (s.mouseover = n)),
                        s.svg
                          .select("." + Y.eventRect)
                          .style("cursor", r ? "pointer" : null),
                        !d.tooltip_grouped || s.hasType("stanford", t))
                      )
                        n && (e = [n]);
                      else {
                        var a;
                        if (n) a = n;
                          ...
                          var o = d.axis_rotated ? i[1] : i[0];
                          a = s.findClosestFromTargetsByX(t, s.x.invert(o));
                        }
                        a && (e = s.filterByX(t, a.x));
                      }
          ...
          .on(
            ...
            d.interaction_enabled
              ? function () {
                  ...
                  if (!s.hasArcType(t)) {
                    var e = c.mouse(this),
                      i = h(s.findClosestFromTargets(t, e));
                    if (u(e, i))
                      if (
                        ((!d.data_selection_grouped || s.isStanfordType(i)
                          ? [i]
                          : s.filterByX(t, i.x)
                        ).forEach(function (t) {
                          s.main
                            .selectAll(
                              "." + Y.shapes + s.getTargetSelectorSuffix(t.id)
                            )
                            .selectAll("." + Y.shape + "-" + t.index)
                            .each(function () {
                              (d.data_selection_grouped ||
                                s.isWithinShape(this, t)) &&
                                s.toggleShape(this, t, t.index);
                            });
                        }),
                        i)
                      ) {
                        var n = s.main
                          .selectAll(
                            "." + Y.shapes + s.getTargetSelectorSuffix(i.id)
                          )
                          .select("." + Y.shape + "-" + i.index);
                        d.data_onclick.call(s.api, i, n.node());
                      }
                  }
                }
              : null
          ...
          .call(
            d.interaction_enabled && d.data_selection_draggable && s.drag
              ? c
                  .drag()
                  .on("drag", function () {
                    s.drag(c.mouse(this));
    ...
    (l.prototype.updateLegend = function (f, t, e) {
      ...
      (f = f.filter(function (t) {
        ...
        m.isLegendInset &&
          ((I = S.legend_inset_step ? S.legend_inset_step : f.length),
    ...
    (l.prototype.updateRegion = function (t) {
      ...
      r
        ...
        .style("fill-opacity", function (t) {
          return C(t.opacity) ? t.opacity : 0.1;
        }),
    ...
    (l.prototype.redrawRegion = function (t, e) {
      ...
      return [
        ...
        (t ? r.transition(e) : r)
          .attr("x", i.labelOffsetX.bind(i))
          .attr("y", i.labelOffsetY.bind(i))
          .attr("transform", i.labelTransform.bind(i))
    ...
    (l.prototype.labelOffsetX = function (t) {
      ...
      return "vertical" in t && t.vertical
        ? this.regionY(t) + i
        : this.regionX(t) + e;
    }),
    ...
    (l.prototype.getY = function (t, e, i) {
      var n;
      if ("timeseries" === t || "time" === t) n = this.d3.scaleTime();
      else if ("log" === t) n = x(this.d3);
      else {
        if ("linear" !== t && void 0 !== t)
          throw new Error('Invalid Y axis type: "'.concat(t, '"'));
        n = this.d3.scaleLinear();
      }
      return e && n.domain(e), i && n.range(i), n;
    }),
    ...
    (l.prototype.updateScales = function () {
      ...
      (e.xMin = t.axis_rotated ? 1 : 0),
        ...
        (e.y = e.getY(t.axis_y_type, i ? t.axis_y_default : e.y.domain(), [
          e.yMin,
          e.yMax,
        ])),
        (e.y2 = e.getY(t.axis_y2_type, i ? t.axis_y2_default : e.y2.domain(), [
          e.yMin,
          e.yMax,
        ])),
    ...
    (l.prototype.getShapeY = function (e) {
      var i = this;
      return function (t) {
        return (e ? i.getSubYScale(t.id) : i.getYScale(t.id))(
          i.isTargetNormalized(t.id) ? i.getRatio("index", t, !0) : t.value
        );
      };
    }),
    (l.prototype.getShapeOffset = function (t, d, e) {
      ...
      return function (r, a) {
        ...
        return (
          i.forEach(function (t) {
            var e = l.isStepType(r)
                ? l.convertValuesToStep(t.values)
                : t.values,
            ...
            t.id !== r.id &&
              d[t.id] === d[r.id] &&
              u.indexOf(t.id) < u.indexOf(r.id) &&
              ((v(e[a]) || +e[a].x != +r.x) &&
                ((a = -1),
                e.forEach(function (t, e) {
                  (t.x.constructor === Date ? +t.x : t.x) ===
                    (r.x.constructor === Date ? +r.x : r.x) && (a = e);
                })),
    ...
    (l.prototype.updateCircle = function (t, e) {
      var i = this,
        n = i.main
          .selectAll("." + Y.circles)
          .selectAll("." + Y.circle)
          .data(i.lineOrScatterOrStanfordData.bind(i)),
        r = n
          .enter()
          .append("circle")
          .attr("shape-rendering", i.isStanfordGraphType() ? "crispEdges" : "")
          ...
          .style(
            "color",
            i.isStanfordGraphType() ? i.getStanfordPointColor.bind(i) : i.color
          );
      (i.mainCircle = r
        .merge(n)
        .style(
          "opacity",
          i.isStanfordGraphType() ? 1 : i.initialOpacityForCircle.bind(i)
        )),
    ...
    (l.prototype.redrawCircle = function (t, e, i, n) {
      ...
      return [
        (i ? r.mainCircle.transition(n) : r.mainCircle)
          ...
          .style(
            "color",
            r.isStanfordGraphType() ? r.getStanfordPointColor.bind(r) : r.color
          )
          .attr("cx", t)
          .attr("cy", e),
    ...
    (l.prototype.pointR = function (t) {
      var e = this.config;
      return this.isStepType(t) ? 0 : g(e.point_r) ? e.point_r(t) : e.point_r;
    }),
    (l.prototype.pointExpandedR = function (t) {
      var e = this.config;
      return e.point_focus_expand_enabled
        ? g(e.point_focus_expand_r)
    ...
    (l.prototype.getCurrentPaddingRight = function () {
      ...
      return (
        (i = C(e.padding_right)
          ...
          : r(t.getAxisWidthByAxisId("y2")) + n),
        t.colorScale && t.colorScale.node() && (i += t.getColorScalePadding()),
        i
      );
    }),
    ...
    (l.prototype.drawColorScale = function () {
      var t,
        ...
        l = s.data.targets[0];
      if (
        ((t = isNaN(d.stanford_scaleWidth) ? 20 : d.stanford_scaleWidth),
        5,
        t < 0)
      )
        throw Error(
          "Colorscale's barheight and barwidth must be greater than 0."
        );
      (o = s.height - d.stanford_padding.bottom - d.stanford_padding.top),
        (i = c.range(d.stanford_padding.bottom, o, 5)),
        (a = c.scaleSequential(l.colors).domain([i[i.length - 1], i[0]])),
        s.colorScale && s.colorScale.remove(),
        (s.colorScale = s.svg
          .append("g")
          .attr("width", 50)
          .attr("height", o)
        ...
        s.colorScale
          ...
          .attr(
            "transform",
            "translate(0, ".concat(d.stanford_padding.top, ")")
          )
          .selectAll("bars")
          .data(i)
          .enter()
        ...
        (r = c
          .scaleLog()
          .domain([l.minEpochs, l.maxEpochs])
          .range([
            i[0] + d.stanford_padding.top + i[i.length - 1] + 5 - 1,
            i[0] + d.stanford_padding.top,
          ])),
        (n = c.axisRight(r)),
        "pow10" === d.stanford_scaleFormat
          ? n.tickValues([1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7])
          : g(d.stanford_scaleFormat)
          ? n.tickFormat(d.stanford_scaleFormat)
          : n.tickFormat(c.format("d")),
        g(d.stanford_scaleValues) &&
          n.tickValues(d.stanford_scaleValues(l.minEpochs, l.maxEpochs)),
        (e = s.colorScale
          .append("g")
          .attr("class", "legend axis")
          .attr("transform", "translate(".concat(t, ",0)"))
          .call(n)),
        "pow10" === d.stanford_scaleFormat &&
          e
            .selectAll(".tick text")
        ...
        s.colorScale.attr(
          "transform",
          "translate(".concat(s.currentWidth - s.xForColorScale(), ", 0)")
        );
    }),
    (l.prototype.xForColorScale = function () {
      return (
        this.config.stanford_padding.right + c(this.colorScale.node()).width
      );
    }),
    ...
    (l.prototype.initStanfordData = function () {
      ...
      (a.colors = g(r.stanford_colors)
        ? r.stanford_colors
        : n.interpolateHslLong(n.hsl(250, 1, 0.5), n.hsl(0, 1, 0.5))),
    ...
    (l.prototype.getCentroid = function (t) {
      var e,
        ...
        s = 0,
        c = 0;
      for (e = 0, i = t.length - 1; e < t.length; i = e, e += 1)
        (r = t[e]),
          (a = t[i]),
          (n = r.x * a.y - a.x * r.y),
          (s += (r.x + a.x) * n),
          (c += (r.y + a.y) * n);
      return { x: s / (n = 6 * o), y: c / n };
    }),
    (l.prototype.getStanfordTooltipTitle = function (t) {
      var e = this.axis.getLabelText("x"),
        i = this.axis.getLabelText("y");
      return "\n      <tr><th>"
        .concat(e ? _(e) : "x", "</th><th class='value'>")
        .concat(t.x, "</th></tr>\n      <tr><th>")
        .concat(i ? _(i) : "y", "</th><th class='value'>")
        .concat(t.value, "</th></tr>\n    ");
    }),
    (l.prototype.countEpochsInRegion = function (i) {
      var t,
        e,
        n = this.data.targets[0];
      return (
        (t = n.values.reduce(function (t, e) {
          return t + Number(e.epochs);
        }, 0)),
        {
          value: (e = n.values.reduce(function (t, e) {
            return w(e, i) ? t + Number(e.epochs) : t;
          }, 0)),
          percentage: 0 !== e ? ((e / t) * 100).toFixed(1) : 0,
        }
      );
    });
  var S = function (t) {
      var e,
        ...
        a = 0;
      for (e = 0, i = t.length - 1; e < t.length; i = e, e += 1)
        (n = t[e]), (r = t[i]), (a += n.x * r.y), (a -= n.y * r.x);
      return (a /= 2);
    },
    w = function (t, e) {
      for (
        var i, n, r, a, o = t.x, s = t.value, c = !1, d = 0, l = e.length - 1;
        d < e.length;
        l = d++
      )
        (i = e[d].x),
  ...
  return (
    (l.prototype.initStanfordElements = function () {
      var t = this;
      (t.stanfordElements = t.main
        .select("." + Y.chart)
        .append("g")
        .attr("class", Y.stanfordElements)),
    ...
    (l.prototype.updateStanfordElements = function (t) {
      var e,
        ...
        l = s.xvCustom.bind(s),
        u = s.yvCustom.bind(s),
        h = s.countEpochsInRegion.bind(s);
      (i = (e = c
        .select("." + Y.stanfordLines)
        .style("shape-rendering", "geometricprecision")
        .selectAll("." + Y.stanfordLine)
        .data(d.stanford_lines))
        .enter()
        .append("g")
        .attr("class", function (t) {
        ...
        .append("line")
        .attr("x1", function (t) {
          return d.axis_rotated ? u(t, "value_y1") : l(t, "value_x1");
        })
        .attr("x2", function (t) {
          return d.axis_rotated ? u(t, "value_y2") : l(t, "value_x2");
        })
        .attr("y1", function (t) {
          return d.axis_rotated ? l(t, "value_x1") : u(t, "value_y1");
        })
        .attr("y2", function (t) {
          return d.axis_rotated ? l(t, "value_x2") : u(t, "value_y2");
        })
        .style("opacity", 0),
        (s.stanfordLines = i.merge(e)),
        s.stanfordLines
          .select("line")
          .transition()
          .duration(t)
        ...
        e.exit().transition().duration(t).style("opacity", 0).remove(),
        (o = (a = c
          .select("." + Y.stanfordTexts)
          .selectAll("." + Y.stanfordText)
          .data(d.stanford_texts))
          .enter()
          .append("g")
          .attr("class", function (t) {
          ...
          .append("text")
          .attr("x", function (t) {
            return d.axis_rotated ? u(t, "y") : l(t, "x");
          })
          .attr("y", function (t) {
            return d.axis_rotated ? l(t, "x") : u(t, "y");
          })
          .style("opacity", 0),
        (s.stanfordTexts = o.merge(a)),
        s.stanfordTexts
          .select("text")
          .transition()
          .duration(t)
        ...
        (r = (n = c
          .select("." + Y.stanfordRegions)
          .selectAll("." + Y.stanfordRegion)
          .data(d.stanford_regions))
          .enter()
          .append("g")
          .attr("class", function (t) {
          ...
          .attr("points", function (t) {
            return t.points
              .map(function (t) {
                return [
                  d.axis_rotated ? u(t, "y") : l(t, "x"),
                  d.axis_rotated ? l(t, "x") : u(t, "y"),
                ].join(",");
              })
              .join(" ");
          })
        ...
        s.stanfordRegions
          ...
          .style("opacity", function (t) {
            return t.opacity ? t.opacity : 0.2;
          }),
        s.stanfordRegions
          .select("text")
          .transition()
          .duration(t)
          .attr("x", function (t) {
            return d.axis_rotated
              ? u(s.getCentroid(t.points), "y")
              : l(s.getCentroid(t.points), "x");
          })
          .attr("y", function (t) {
            return d.axis_rotated
              ? l(s.getCentroid(t.points), "x")
          ...
          .text(function (t) {
            var e, i, n;
            return t.text
              ? (s.isStanfordGraphType() &&
                  ((e = (n = h(t.points)).value), (i = n.percentage)),
                t.text(e, i))
              : "";
          })
          .attr("text-anchor", "middle")
    ...
    (l.prototype.initTooltip = function () {
      ...
      if (
        ...
        if (e.isTimeSeries() && p(i.tooltip_init_x)) {
          for (
    ...
    (l.prototype.getTooltipSortFunction = function () {
      ...
      if (p(n) && "asc" === n.toLowerCase())
        return function (t, e) {
          return r(t) - r(e);
        };
      if (p(n) && "desc" === n.toLowerCase())
        return function (t, e) {
          return r(e) - r(t);
        };
      if (g(n)) {
    ...
    (l.prototype.getTooltipContent = function (t, e, i, n) {
      var r,
        ...
        p = u.tooltip_format_value;
      p ||
        (p = l.isTargetNormalized(t.id)
          ? function (t, e) {
              return "".concat((100 * e).toFixed(2), "%");
            }
          : i);
      var f = this.getTooltipSortFunction();
      for (f && t.sort(f), a = 0; a < t.length; a++)
        if (t[a] && (t[a].value || 0 === t[a].value)) {
          if (l.isStanfordGraphType())
            r ||
              ((o = l.getStanfordTooltipTitle(t[a])),
            ...
            (r ||
              ...
              (r =
                ...
                (o || 0 === o
                  ...
                  : ""))),
            void 0 !==
              (s = _(p(t[a].value, t[a].ratio, t[a].id, t[a].index, t))))
          ) {
          ...
          void 0 !== s &&
            ((r +=
              ...
              "'>"),
            (r +=
              "<td class='name'><span style='Backendground-color:" +
              d +
              "'></span>" +
              c +
              "</td>"),
    ...
    (l.prototype.lineOrScatterOrStanfordData = function (t) {
      return this.isLineType(t) ||
        this.isScatterType(t) ||
        this.isStanfordType(t)
        ? t.values
        : [];
    }),
