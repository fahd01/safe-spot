...
class InvestissementController extends AbstractController
{
    ...
    {
        $messageStatus = $this->twilioClient->sendSms(
            '+21694878107', // Recipient phone number
            'New Inverstissement Added !' // Message
        );
    ...
    #[Route('/ivpdf', name: 'app_inv_pdf', methods: ['GET'])]
    public function exportPdf(Request $request, InvestissementRepository $repo): Response
    {
        $Investissement = $repo->findAll();
        ...
        $html = $this->renderView('investissement/pdf.html.twig', ['Investissement' => $Investissement]);
        ...
        // Stream the file
        $dompdf->stream("investissement.pdf", [
            "Attachment" => true
        ]);
