 ...
 */
final class Version20240216234714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE investissement ADD id_user_id INT NOT NULL, ADD iduser_id INT NOT NULL, ADD id_investisseur_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE investissement ADD CONSTRAINT FK_B8E64E0141A70F42 FOREIGN KEY (id_investisseur_id) REFERENCES user (id)');
        ...
        $this->addSql('CREATE INDEX IDX_B8E64E0141A70F42 ON investissement (id_investisseur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE investissement DROP FOREIGN KEY FK_B8E64E0141A70F42');
        ...
        $this->addSql('DROP INDEX IDX_B8E64E0141A70F42 ON investissement');
        $this->addSql('ALTER TABLE investissement DROP id_user_id, DROP iduser_id, DROP id_investisseur_id');
    }
}
