 ...
 */
class getExpRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExpRepository' shared autowired service.
     *
     * @return \App\Repository\ExpRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExpRepository.php';

        return $container->privates['App\\Repository\\ExpRepository'] = new \App\Repository\ExpRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
